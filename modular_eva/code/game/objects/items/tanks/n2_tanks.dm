...
/obj/item/tank/internals/nitrogen/belt
	icon = 'modular_eva/icons/obj/tank.dmi'
	lefthand_file = 'modular_eva/icons/mob/inhands/equipment/tanks_lefthand.dmi'
	righthand_file = 'modular_eva/icons/mob/inhands/equipment/tanks_righthand.dmi'
