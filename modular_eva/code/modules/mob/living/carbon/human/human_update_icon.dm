	...
	if(istype(w_uniform, /obj/item/clothing/under))
		...
		switch(applied_style)
			if(STYLE_DIGITIGRADE)
				icon_file = w_uniform.worn_icon_digi || 'modular_eva/icons/mob/clothing/under/uniform_digi.dmi'
			if(STYLE_TAUR_SNAKE)
				icon_file = w_uniform.worn_icon_taur_snake || 'modular_eva/icons/mob/clothing/under/uniform_taur_snake.dmi'
			if(STYLE_TAUR_HOOF)
				icon_file = w_uniform.worn_icon_taur_hoof || 'modular_eva/icons/mob/clothing/under/uniform_taur_hoof.dmi'
			if(STYLE_TAUR_PAW)
				icon_file = w_uniform.worn_icon_taur_paw || 'modular_eva/icons/mob/clothing/under/uniform_taur_paw.dmi'
...
/mob/living/carbon/human/update_inv_wear_suit()
	...
	if(istype(wear_suit, /obj/item/clothing/suit))
		...
		switch(applied_style)
			if(STYLE_DIGITIGRADE)
				icon_file = wear_suit.worn_icon_digi || 'modular_eva/icons/mob/clothing/suit_digi.dmi'
			if(STYLE_TAUR_SNAKE)
				icon_file = wear_suit.worn_icon_taur_snake || 'modular_eva/icons/mob/clothing/suit_taur_snake.dmi'
			if(STYLE_TAUR_HOOF)
				icon_file = wear_suit.worn_icon_taur_hoof || 'modular_eva/icons/mob/clothing/suit_taur_hoof.dmi'
			if(STYLE_TAUR_PAW)
				icon_file = wear_suit.worn_icon_taur_paw || 'modular_eva/icons/mob/clothing/suit_taur_paw.dmi'
...
/mob/living/carbon/human/update_inv_shoes()
	...
	if(shoes)
		...
		if((DIGITIGRADE in dna.species.species_traits) && (shoes.mutant_variants & STYLE_DIGITIGRADE))
			...
			icon_file = shoes.worn_icon_digi || 'modular_eva/icons/mob/clothing/feet_digi.dmi'
	...
	if(glasses)
		...
		if(!(head && (head.flags_inv & HIDEEYES)) && !(wear_mask && (wear_mask.flags_inv & HIDEEYES)))
			...
			if(dna.species.id == "vox")
				...
				icon_file = 'modular_eva/icons/mob/clothing/eyes_vox.dmi'
