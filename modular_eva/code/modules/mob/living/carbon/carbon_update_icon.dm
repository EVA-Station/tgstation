...
/mob/living/carbon/update_inv_head()
	...
	if(head)
		...
		switch(used_style)
			if(STYLE_MUZZLE)
				desired_icon = head.worn_icon_muzzled || 'modular_eva/icons/mob/clothing/head_muzzled.dmi'
			if(STYLE_VOX)
				desired_icon = 'modular_eva/icons/mob/clothing/head_vox.dmi'
...
/mob/living/carbon/update_inv_wear_mask()
	...
	if(wear_mask)
		...
		switch(used_style)
			if(STYLE_MUZZLE)
				desired_icon = wear_mask.worn_icon_muzzled || 'modular_eva/icons/mob/clothing/mask_muzzled.dmi'
			if(STYLE_VOX)
				desired_icon = 'modular_eva/icons/mob/clothing/mask_vox.dmi'
