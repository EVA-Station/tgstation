...
/datum/sprite_accessory/wings/moth
	icon = 'modular_eva/icons/mob/sprite_accessory/moth_wings.dmi' //Needs new icon to suit new naming convention
	default_color = "FFF"
...
/datum/sprite_accessory/wings/mammal
	icon = 'modular_eva/icons/mob/sprite_accessory/wings.dmi'
